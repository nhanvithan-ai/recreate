  ...
  if (wishlistedProducts.length === 0) {
    return (
      <div className="max-w-7xl mx-auto px-6 py-48 text-center relative">
        ...
        <h2 className="text-6xl md:text-8xl font-display gold-gradient-text mb-8">Wishlist is Empty</h2>
        <p className="text-blush/40 font-serif text-2xl italic tracking-widest mb-16 max-w-lg mx-auto">
          "Save the products you love to your wishlist and find them here later."
        </p>
        <Link 
          to="/" 
  ...
  return (
    <div className="max-w-7xl mx-auto px-6 py-20 relative">
      ...
      <div className="flex flex-col md:flex-row md:items-end justify-between mb-24 border-b border-white/5 pb-10">
        <div>
          <h2 className="text-6xl md:text-8xl font-display gold-gradient-text">My Wishlist</h2>
          <p className="font-label text-silk italic text-2xl tracking-widest mt-4">Selected products from Recreate873.</p>
        </div>
        <div className="mt-8 md:mt-0 font-accent text-[10px] uppercase tracking-[0.5em] text-gold/40">
          {wishlistedProducts.length} Products
        </div>
      </div>
